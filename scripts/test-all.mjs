...
if (includeUi) {
  suites.push(
    ...
    { name: 'catalog-nav', cmd: 'node', args: ['scripts/test-catalog-navigation.mjs'], env: { UI_SMOKE_URL: url } },
    { name: 'kiosk-nav', cmd: 'node', args: ['scripts/test-kiosk-navigation.mjs'], env: { UI_SMOKE_URL: url } },
