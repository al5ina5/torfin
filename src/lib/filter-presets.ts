...
export const builtInFilterPresets: FilterPreset[] = [
  preset('90s-classics', '90s Classics', { yearFrom: '1990', yearTo: '1999', sortBy: 'ratingDesc' }),
  preset('top-horror', 'Top Horror', { genre: 'Horror', minRating: '7', sortBy: 'ratingDesc' }),
  preset('recent-scifi', 'Recent Sci-Fi', { genre: 'Sci-Fi', sortBy: 'yearDesc' }),
  preset('family-friendly', 'Family Friendly', { genre: 'Family', minRating: '6', sortBy: 'ratingDesc' }),
  preset('80s-action', '80s Action', { genre: 'Action', yearFrom: '1980', yearTo: '1989', sortBy: 'ratingDesc' }),
  preset('70s-cinema', '70s Cinema', { yearFrom: '1970', yearTo: '1979', minRating: '6', sortBy: 'ratingDesc' }),
  preset('2000s-hits', '2000s Hits', { yearFrom: '2000', yearTo: '2009', sortBy: 'ratingDesc' }),
  preset('2010s-best', '2010s Best', { yearFrom: '2010', yearTo: '2019', minRating: '6', sortBy: 'ratingDesc' }),
  ...
  preset('mind-bending-scifi', 'Mind-Bending Sci-Fi', { genre: 'Sci-Fi', minRating: '7', sortBy: 'ratingDesc' }),
  preset('creepy-horror', 'Creepy Horror', { genre: 'Horror', minRating: '7', sortBy: 'ratingDesc' }),
  preset('feel-good-comedy', 'Feel-Good Comedy', { genre: 'Comedy', minRating: '6', sortBy: 'ratingDesc' }),
  preset('award-season', 'Award Season', { genre: 'Drama', minRating: '7', sortBy: 'ratingDesc' }),
  preset('date-night', 'Date Night', { genre: 'Romance', minRating: '6', sortBy: 'ratingDesc' }),
  ...
  preset('animated-gems', 'Animated Gems', { genre: 'Animation', minRating: '7', sortBy: 'ratingDesc' }),
  preset('cult-classics', 'Cult Classics', { yearFrom: '1975', yearTo: '1989', minRating: '6', sortBy: 'ratingDesc' }),
  preset('modern-masterpieces', 'Modern Masterpieces', { yearFrom: '2015', minRating: '7', sortBy: 'ratingDesc' }),
  ...
  preset('summer-blockbusters', 'Summer Blockbusters', { genre: 'Action', yearFrom: '2000', sortBy: 'ratingDesc' }),
  preset('cozy-night-in', 'Cozy Night In', { genre: 'Comedy', minRating: '6', yearFrom: '1990', sortBy: 'ratingDesc' }),
  preset('edge-of-seat', 'Edge of Seat', { genre: 'Thriller', minRating: '7', sortBy: 'ratingDesc' }),
  preset('recent-horror', 'Recent Horror', { genre: 'Horror', sortBy: 'yearDesc' }),
  ...
  preset('classic-comedy', 'Classic Comedy', { genre: 'Comedy', yearTo: '1989', minRating: '6', sortBy: 'ratingDesc' }),
  preset('classic-thriller', 'Classic Thriller', { genre: 'Thriller', minRating: '6', sortBy: 'ratingDesc' }),
